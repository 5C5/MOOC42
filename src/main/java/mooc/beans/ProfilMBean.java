...
public class ProfilMBean extends AbstractMBean implements Serializable {
    ...
    /**
     * Apprenant dont le profil est affich�.
     */
    ...
    public void init() {
        ...
        // TODO r�cup�rer l'ID de l'apprenant, r�cup�rer son profil en base
        // TODO r�cup�rer la liste des comp�tences qu'a r�alis� l'apprenant
