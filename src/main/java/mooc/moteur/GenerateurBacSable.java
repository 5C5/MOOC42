...
public class GenerateurBacSable extends Generateur {
	...
	public void generer(final List<String> portes, final boolean drag) {
		this.genererEntree(drag);
		this.genererPorteUnaire(drag);
		this.genererPorteBinaire(drag);
		this.genererSortie(drag);
	}

	private void genererEntree(final boolean drag) {
		Valeur entree = null;
		int y = 5;
	...
	private void genererPorteUnaire(final boolean drag) {
		Porte porte = null;
		int y = 5;
		for (int i = 0; i < this.nbPorteUnaire; i++) {
			porte = new Porte("", "");
			porte.setData("");
			porte.setX("40em");
			porte.setY(y + "em");
	...
	private void genererPorteBinaire(final boolean drag) {
		Porte porte = null;
		int y = 5;
		for (int i = 0; i < this.nbPorteBinaire; i++) {
			porte = new Porte("", "");
			porte.setData("");
			porte.setX("60em");
			porte.setY(y + "em");
